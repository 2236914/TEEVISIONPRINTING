...
import ScreenPrintingBody from '@/components/services/screen-printing/ScreenPrintingBody';
import Footer from '@/components/shared/Footer/Footer';
import MainNavigation from '@/components/shared/Navigation/components/MainNavigation/MainNavigation';

export const metadata: Metadata = {
  title: 'Best Screen Printing in Philadelphia | Custom T-Shirts & Hoodies',
  description:
    'Get the highest quality screen printing service for your shirts & hoodies at an affordable price only at Tee Vision Printing based in Philadelphia.',
  keywords:
  ...
  alternates: {
    canonical: 'https://www.teevisionprinting.com/services',
  },
};
