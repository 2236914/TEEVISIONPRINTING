...
import CustomCrewneckSchema from '@/components/schemas/CustomCrewneckSchema';
...
const PROJECTS: Project[] = [
  { imageSrc: '/custom-crewneck/2-converted-from-png.webp' },
  { imageSrc: '/custom-crewneck/3-converted-from-png.webp' },
  { imageSrc: '/custom-crewneck/4-converted-from-png.webp' },
  { imageSrc: '/custom-crewneck/5-converted-from-png.webp' },
];
...
const PRODUCT_DATA: Record<string, Product[]> = {
  ...
  'PIGMENT-DYED CREWNECKS': [
    ...
    },
    {
      ...
      rating: 5.0,
      price: '$34.25 / sweatshirt',
      image: '/custom-crewnecks/comfort-colors-crewneck.webp',
      link: '/products/view/comfort-colors-crewneck'
    },
    {
      name: 'Independent Trading Co. Heavyweight Crewneck Sweatshirt (IND3000)',
      rating: 5.0,
      price: '$36.16 / sweatshirt',
      image: '/screen-printing/new-screen-printing/sweatshirts/1-converted-from-jfif.webp',
      link: '/products/independent-crewneck-ind3000'
    }
  ],
  'PREMIUM CREWNECKS': [
    {
...
const ProductTabsHeader = memo(({ activeTab, setActiveTab }: { activeTab: string; setActiveTab: (tab: string) => void }) => {
  const tabs = ['HEAVYWEIGHT CREWNECKS', 'PIGMENT-DYED CREWNECKS', 'PREMIUM CREWNECKS'];
          ...
          >
            {projects.map((project, index) => (
              <div
                ...
                role="button"
                tabIndex={0}
                aria-label={`View featured crewneck design ${index + 1}`}
              >
                <div className="relative aspect-square w-full">
                  <Image
                    src={project.imageSrc}
                    fill
                    alt={`Featured crewneck design ${index + 1}`}
        ...
        >
          <div className="relative w-full max-w-4xl h-[80vh]">
            <Image
              src={selectedImage}
              fill
              alt="Featured crewneck full size"
...
// Main Component
const CustomCrewneck = () => {
  const [activeTab, setActiveTab] = useState('HEAVYWEIGHT CREWNECKS');
  ...
  return (
    <main className="bg-white">
      ...
      <section className="w-full relative flex overflow-hidden bg-[#1a1a1a]">
        <div className="flex flex-col w-full z-[1]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-8 md:px-12 xl:px-24 py-16 md:py-20 xl:py-24 pt-32 md:pt-36 xl:pt-40">
            ...
            <div className="flex flex-col gap-8 text-white">
              <div>
                ...
                <h1 className={`${Termina} uppercase font-black text-6xl md:text-7xl xl:text-8xl 2xl:text-7xl mt-2 leading-[0.9]`}>
                  ...
                  <br />
                  <span className="text-[#FFC107]">CREWNECKS</span>
                  <br />
              ...
              <p className={`${MaisonNeue} text-base md:text-lg xl:text-xl text-gray-300 max-w-2xl leading-relaxed`}>
                Custom crewneck sweatshirts designed to showcase your ideas on durable, high-quality apparel including <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/products/category/polos'>polos</a></span>, <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/products/category/sweatshirts-hoodies/hooded-sweatshirts'>hoodies</a></span>, <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/products/category/t-shirts'>T-shirts</a></span>, <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/products/category/tote-bags-more/tote-bag'>tote bags</a></span>, and more.
              </p>
              ...
              <div className="flex flex-col md:flex-row gap-4 w-full xl:w-fit items-stretch mt-4">
                <RequestAQuoteModalGeneralServerWrapper className="w-full xl:w-fit">
                  <div
                    className={`${MaisonNeue} w-full py-4 xl:py-4 xl:px-12 h-full bg-[#FFC107] border-[#FFC107] !text-black font-extrabold border-[0.2rem] text-button md:text-button-md lg:text-[1.15rem] rounded-md transition transform hover:scale-105 hover:bg-[#FFD54F] hover:border-[#FFD54F] min-w-[280px] flex items-center justify-center`}
                    style={{ height: '64px'}}
                  >
                    REQUEST A QUOTE
                  </div>
            ...
            {/* Right Side - Hero Image (crewnecks on rack) */}
            <div className="flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[700px] aspect-[4/3] rounded-3xl overflow-hidden">
                <Image
                  src="/custom-crewneck/1-converted-from-png.webp"
                  fill
                  alt="Custom crewneck sweatshirts"
      ...
      {/* Featured Crewneck Designs Section */}
        ...
        <div className="max-w-[75rem] mx-auto px-8">
          ...
          <div className="text-center mb-12">
            <h2 className={`${Termina} font-black text-[2.5rem] md:text-[3rem] xl:text-[3.5rem] mb-4`}>
              ...
              <span className="text-[#FFC107]">CUSTOM CREWNECK SWEATSHIRTS DESIGN</span>
            </h2>
          </div>
          ...
          <div className="max-w-[75rem] w-full px-8">
            <div className="text-center mb-8">
              <h2 className={`${Termina} font-black text-[#FFC107] text-[2rem] md:text-[2.5rem] xl:text-[3rem] mb-4`}>
                <span className="text-[#000000]">SEE OUR </span>CUSTOM CREWNECK SWEATSHIRTS COLLECTIONS
              </h2>
      ...
      <section className="w-full bg-white py-16">
        <div className="max-w-[75rem] mx-auto px-8">
          ...
          <div className="text-center mb-12">
            <h2 className={`${Termina} font-black text-[2.5rem] md:text-[3rem] xl:text-[3.5rem] mb-4`}>
              <span className="text-[#FFC107]">CUSTOM CREWNECK SWEATSHIRTS PRINTING METHODS</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link href="/services/screen-printing" className="group">
              <div className="relative overflow-hidden rounded-lg border-4 border-transparent hover:border-[#FFC107] transition-all duration-300 h-full flex flex-col">
                <div className="relative h-64 flex-grow">
                  <Image
                    src="/custom-crewneck/6-converted-from-png.webp"
                    fill
            ...
            <Link href="/services/embroidery" className="group">
              <div className="relative overflow-hidden rounded-lg border-4 border-transparent hover:border-[#FFC107] transition-all duration-300 h-full flex flex-col">
                <div className="relative h-64 flex-grow">
                  <Image
                    src="/custom-crewneck/7-converted-from-png.webp"
                    fill
            ...
            <Link href="/services/dtg" className="group">
              <div className="relative overflow-hidden rounded-lg border-4 border-transparent hover:border-[#FFC107] transition-all duration-300 h-full flex flex-col">
                <div className="relative h-64 flex-grow">
                  <Image
                    src="/custom-crewneck/8-converted-from-png.webp"
                    fill
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full aspect-square mb-4 overflow-hidden">
          <Image
            src="/custom-crewneck/9-converted-from-png.webp"
            fill
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full aspect-square mb-4 overflow-hidden">
          <Image
            src="/custom-crewneck/10-converted-from-png.webp"
            fill
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full aspect-square mb-4 overflow-hidden">
          <Image
            src="/custom-crewneck/11-converted-from-png.webp"
            fill
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full aspect-square mb-4 overflow-hidden">
          <Image
            src="/custom-crewneck/12-converted-from-png.webp"
            fill
      ...
      {/* Our Custom Crewnecks Are Great Section */}
        ...
        <div className="max-w-[75rem] mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-12 items-center">
            ...
            <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden rounded-lg">
              <Image
                src="/custom-crewneck/13-converted-from-png.webp"
                fill
                alt="Custom crewneck sweatshirts collection"
                className="object-cover"
                loading="lazy"
            ...
            <div className="flex flex-col gap-6">
              <h2 className={`${Termina} font-black text-[2rem] md:text-[2.5rem] xl:text-[3.5rem] leading-tight`}>
                <span className="text-black">OUR CUSTOM CREWNECK SWEATSHIRTS</span>
                <br />
                <span className="text-black">Are Great!</span>
              </h2>
              <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                Have a concept you want on a tee? <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/'>Tee Vision Printing</a></span> produces custom long sleeve shirts in Philadelphia with polished results for branding, events or everyday gear.
              </p>
        ...
        <div className="max-w-[75rem] w-full flex flex-col xl:flex-row items-center gap-6 xl:gap-10 px-8 relative">
          ...
          <div className="w-full xl:w-[53%] xl:absolute xl:right-0 xl:translate-x-[15%]">
            <div className="relative w-full h-[400px] xl:h-[600px]">
              <Image
                src="/custom-crewneck/14-converted-from-png.webp"
                fill
      ...
      <section className="w-full bg-white py-8 xl:py-12">
        <div className="max-w-[75rem] mx-auto px-8">
          ...
          <div className="text-center mb-10">
            ...
            <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 max-w-4xl mx-auto`}>
              Got questions about custom crewneck sweatshirts? Explore our Frequently Asked Questions to learn more about our products, printing process, and ordering.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto space-y-4">
            ...
            <div className={`${openFaqIndex === 0 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  What materials are used for custom crewneck sweatshirts?
                </h3>
              ...
              {openFaqIndex === 0 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    Most crewnecks are made from cotton, fleece, or cotton-poly blends. Cotton gives softness, fleece adds warmth, and blended fabrics offer durability and great print quality. Explore similar apparel in our <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/products'>products</a></span>.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className={`${openFaqIndex === 1 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  Can you print on the front, back, and sleeves of a crewneck?
                </h3>
                <span className="text-2xl font-bold text-black flex-shrink-0">
                  {openFaqIndex === 1 ? '×' : '+'}
                </span>
              ...
              {openFaqIndex === 1 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    Yes, many printers can add designs to the chest, back, and sleeves. Placement depends on the printing method and artwork layout, giving you full flexibility for creative or branded looks. Check our <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/past-projects'>past projects</a></span>.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className={`${openFaqIndex === 2 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  What printing method is best for custom crewnecks?
                </h3>
                <span className="text-2xl font-bold text-black flex-shrink-0">
                  {openFaqIndex === 2 ? '×' : '+'}
                </span>
              ...
              {openFaqIndex === 2 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/services/screen-printing'>Screen printing</a></span> is ideal for bold, bulk designs, DTF suits full-color prints, and embroidery adds a premium textured look. The best option depends on your budget, design style, and quantity.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className={`${openFaqIndex === 3 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  Can crewnecks be customized for events and giveaways?
                </h3>
                <span className="text-2xl font-bold text-black flex-shrink-0">
                  {openFaqIndex === 3 ? '×' : '+'}
                </span>
              ...
              {openFaqIndex === 3 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    Absolutely! <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/products/category/sweatshirts-hoodies/crewneck-sweatshirts'>Custom crewnecks</a></span> are great for corporate events, school programs, sports teams, and giveaways because they&apos;re practical, stylish, and offer plenty of space for branding.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className={`${openFaqIndex === 4 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  Are custom crewnecks available in unisex and oversized styles?
                </h3>
                <span className="text-2xl font-bold text-black flex-shrink-0">
                  {openFaqIndex === 4 ? '×' : '+'}
                </span>
              ...
              {openFaqIndex === 4 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    Yes, we offer unisex, standard-fit, and oversized crewnecks to make sure everyone gets the right fit. For sizing help or special requests, feel free to reach out through our <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/contact'>contact page</a></span>.
                  </p>
                </div>
              )}
            </div>
