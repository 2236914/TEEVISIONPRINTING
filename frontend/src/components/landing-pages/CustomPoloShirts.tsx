...
import CustomPoloShirtsSchema from '@/components/schemas/CustomPoloShirtsSchema';
...
// Lazy loaded components for OTHER SECTIONS (matching the design button style)
...
const PROJECTS: Project[] = [
  { imageSrc: '/custom-polo-shirts/2-converted-from-png.webp' },
  { imageSrc: '/custom-polo-shirts/3-converted-from-png.webp' },
  { imageSrc: '/custom-polo-shirts/4-converted-from-png.webp' },
  { imageSrc: '/custom-polo-shirts/5-converted-from-png.webp' },
];

const DESCRIPTIONS = [
  { title: 'Screen Print Orders', subtitle: 'Starting 12 pieces', icon: <Needle width={52} height={52} /> },
  { title: 'Premium Fabrics', subtitle: 'Breathable & Durable', icon: <Scissors width={52} height={52} /> },
...
const PRODUCT_DATA: Record<string, Product[]> = {
  ...
  //   //   rating: 5.0,
  //   //   price: '$18.50 / shirt',
  //   //   image: '/custom-polo-shirts/gildan-dryblend-polo.webp',
  //   //   link: '/products/view/gildan-dryblend-polo-8800'
  //   // },
  //   // {
  //   //   name: 'Port Authority® Silk Touch™ Performance Polo (K540)',
  //   //   rating: 5.0,
  //   //   price: '$22.75 / shirt',
  //   //   image: '/custom-polo-shirts/port-authority-performance-polo.webp',
  //   //   link: '/products/view/port-authority-performance-polo-k540'
  //   // }
  //   // {
  //   //   name: 'Nike Dri-FIT Micro Pique Polo (363807)',
  //   //   rating: 5.0,
  //   //   price: '$38.90 / shirt',
  //   //   image: '/custom-polo-shirts/nike-dri-fit-polo.webp',
  //   //   link: '/products/view/nike-dri-fit-polo-363807'
  //   // }
  //   // {
  //   //   name: 'Jerzees SpotShield™ 5.6-Ounce Jersey Knit Sport Shirt (437)',
  //   //   rating: 5.0,
  //   //   price: '$16.25 / shirt',
  //   //   image: '/custom-polo-shirts/jerzees-spotshield-polo.webp',
  //   //   link: '/products/view/jerzees-spotshield-polo-437'
  //   // }
  // ],
  'PERFORMANCE POLOS': [
    {
    ...
    },
    {
      ...
      rating: 5.0,
      price: '$24.50 / shirt',
      image: '/custom-polo-shirts/sport-tek-racermesh-polo.webp',
      link: '/products/view/sport-tek-racermesh-polo-st640'
    }
  ],
  'LADIES POLO SHIRTS': [
    {
      ...
      rating: 5.0,
      price: '$20.90 / shirt',
      image: '/custom-polo-shirts/ladies-port-authority-polo.webp',
      link: '/products/view/ladies-port-authority-polo-l500'
    },
    {
      name: 'Nike Ladies Dri-FIT Micro Pique Polo (354067)',
      rating: 5.0,
      price: '$36.75 / shirt',
      image: '/custom-polo-shirts/ladies-nike-dri-fit-polo.webp',
      link: '/products/view/ladies-nike-dri-fit-polo-354067'
    },
    {
      name: 'Sport-Tek® Ladies PosiCharge® RacerMesh® Polo (LST640)',
      rating: 5.0,
      price: '$23.50 / shirt',
      image: '/custom-polo-shirts/ladies-sport-tek-polo.webp',
      link: '/products/view/ladies-sport-tek-polo-lst640'
    },
    {
      name: 'Gildan DryBlend® Ladies 6-Ounce Jersey Knit Sport Shirt (82800L)',
      rating: 5.0,
      price: '$17.90 / shirt',
      image: '/custom-polo-shirts/ladies-gildan-polo.webp',
      link: '/products/view/ladies-gildan-polo-82800l'
    }
  ]
};
...
const ProductTabsHeader = memo(({ activeTab, setActiveTab }: { activeTab: string; setActiveTab: (tab: string) => void }) => {
  const tabs = ['PERFORMANCE POLOS', 'LADIES POLO SHIRTS'];
          ...
          >
            {projects.map((project, index) => (
              <div
                ...
                role="button"
                tabIndex={0}
                aria-label={`View featured polo shirt design ${index + 1}`}
              >
                <div className="relative aspect-square w-full">
                  <Image
                    src={project.imageSrc}
                    fill
                    alt={`Featured polo shirt design ${index + 1}`}
        ...
        >
          <div className="relative w-full max-w-4xl h-[80vh]">
            <Image
              src={selectedImage}
              fill
              alt="Featured polo shirt full size"
...
// Main Component
const CustomPoloShirts = () => {
  const [activeTab, setActiveTab] = useState('PERFORMANCE POLOS');
  ...
  return (
    <main className="bg-white">
      ...
      <section className="w-full relative flex overflow-hidden bg-[#1a1a1a]">
        <div className="flex flex-col w-full z-[1]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-8 md:px-12 xl:px-24 py-16 md:py-20 xl:py-24 pt-32 md:pt-36 xl:pt-40">
            ...
            <div className="flex flex-col gap-8 text-white">
              <div>
                ...
                <h1 className={`${Termina} uppercase font-black text-6xl md:text-7xl xl:text-8xl 2xl:text-7xl mt-2 leading-[0.9]`}>
                  ...
                  <br />
                  <span className="text-[#FFC107]">POLO SHIRTS</span>
                </h1>
              </div>
              <p className={`${MaisonNeue} text-base md:text-lg xl:text-xl text-gray-300 max-w-2xl leading-relaxed`}>
                Custom polo shirts designed to showcase your ideas on durable, high-quality apparel including <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/products/category/polos'>polos</a></span>, <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/products/category/sweatshirts-hoodies/hooded-sweatshirts'>hoodies</a></span>, <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/products/category/t-shirts'>T-shirts</a></span>, <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/products/category/tote-bags-more/tote-bag'>tote bags</a></span>, and more.
              </p>
            ...
            {/* Right Side - Hero Image (polo shirts display) */}
            <div className="flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[700px] aspect-[4/3] rounded-3xl overflow-hidden">
                <Image
                  src="/custom-polo-shirts/1-converted-from-png.webp"
                  fill
                  alt="Professional custom polo shirts"
      ...
      {/* Featured Polo Shirt Designs Section */}
        ...
        <div className="max-w-[75rem] mx-auto px-8">
          ...
          <div className="text-center mb-12">
            <h2 className={`${Termina} font-black text-[2.5rem] md:text-[3rem] xl:text-[3.5rem] mb-4`}>
              ...
              <span className="text-[#FFC107]">POLO SHIRT DESIGNS</span>
            </h2>
          </div>
          ...
          <div className="max-w-[75rem] w-full px-8">
            <div className="text-center mb-8">
              <h2 className={`${Termina} font-black text-[#FFC107] text-[2rem] md:text-[2.5rem] xl:text-[3rem] mb-4`}>
                <span className="text-[#000000]">SEE OUR </span>POLO SHIRTS FOR COLLECTIONS
              </h2>
      ...
      <section className="w-full bg-white py-16">
        <div className="max-w-[75rem] mx-auto px-8">
          ...
          <div className="text-center mb-12">
            <h2 className={`${Termina} font-black text-[2.5rem] md:text-[3rem] xl:text-[3.5rem] mb-4`}>
              <span className="text-[#FFC107]">PRINTING METHODS</span>
            </h2>
            <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 max-w-4xl mx-auto`}>
              At Tee Vision Printing, we use several printing methods to achieve the best results for every design, fabric, and order size. Click to learn more about each method.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link href="/services/screen-printing" className="group">
              <div className="relative overflow-hidden rounded-lg border-4 border-transparent hover:border-[#FFC107] transition-all duration-300 h-full flex flex-col">
                <div className="relative h-64 flex-grow">
                  <Image
                    src="/custom-polo-shirts/6-converted-from-png.webp"
                    fill
                    alt="Screen Printing on polo shirts"
                    className="object-cover"
                    loading="lazy"
            ...
            <Link href="/services/embroidery" className="group">
              <div className="relative overflow-hidden rounded-lg border-4 border-transparent hover:border-[#FFC107] transition-all duration-300 h-full flex flex-col">
                <div className="relative h-64 flex-grow">
                  <Image
                    src="/custom-polo-shirts/7-converted-from-png.webp"
                    fill
                    alt="Embroidery on polo shirts"
                    className="object-cover"
                    loading="lazy"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    quality={85}
            ...
            <Link href="/services/dtg" className="group">
              <div className="relative overflow-hidden rounded-lg border-4 border-transparent hover:border-[#FFC107] transition-all duration-300 h-full flex flex-col">
                <div className="relative h-64 flex-grow">
                  <Image
                    src="/custom-polo-shirts/8-converted-from-png.webp"
                    fill
                    alt="DTG Direct to Garment on polo shirts"
                    className="object-cover"
                    loading="lazy"
                    sizes="(max-width: 768px) 100vw, 33vw"
                    quality={85}
...
<section className="w-full bg-white py-16">
  <div className="max-w-[75rem] mx-auto px-8">
    ...
    <div className="text-center mb-12">
      <h2 className={`${Termina} font-black text-[2.5rem] md:text-[3rem] xl:text-[3.5rem] mb-4`}>
        <span className="text-black">CUSTOM POLO SHIRTS </span>
        <span className="text-[#FFC107]">PRINTING METHODS</span>
        </h2>
        <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 max-w-4xl mx-auto`}>
          At Tee Vision Printing, we create custom polo shirts using reliable printing methods for bold, long-lasting designs. Click to see which method fits your polo project.
        </p>
    </div>
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full aspect-square mb-4 overflow-hidden">
          <Image
            src="/custom-polo-shirts/9-converted-from-png.webp"
            fill
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full aspect-square mb-4 overflow-hidden">
          <Image
            src="/custom-polo-shirts/10-converted-from-png.webp"
            fill
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full aspect-square mb-4 overflow-hidden">
          <Image
            src="/custom-polo-shirts/11-converted-from-png.webp"
            fill
        ...
        <Link href="/products/category/sweatshirts-hoodies" className="group w-full">
          <div className="bg-[#FFC107] px-4 py-2 group-hover:bg-[#FFD54F] transition-colors w-full text-center">
            <h3 className={`${Termina} font-black text-sm md:text-base text-black uppercase`}>
              SWEATSHIRT
            </h3>
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full aspect-square mb-4 overflow-hidden">
          <Image
            src="/custom-polo-shirts/12-converted-from-png.webp"
            fill
      ...
      {/* Our Custom Polo Shirts Are Great Section */}
        ...
        <div className="max-w-[75rem] mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-12 items-center">
            ...
            <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden rounded-lg">
              <Image
                src="/custom-polo-shirts/13-converted-from-png.webp"
                fill
                alt="Custom polo shirts for business"
                className="object-cover"
                loading="lazy"
            ...
            <div className="flex flex-col gap-6">
              <h2 className={`${Termina} font-black text-[2rem] md:text-[2.5rem] xl:text-[3.5rem] leading-tight`}>
                <span className="text-black">Our Custom Polo Shirts</span>
                <br />
                <span className="text-black">Are Great!</span>
              </h2>
              <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                Got a design in mind? <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/'>Tee Vision Printing</a></span> brings your ideas to life with premium custom polo shirts in Philadelphia. Perfect for business, events, or personal use with high-quality prints, great value, and standout Philly style.
              </p>
      ...
      <section className="w-full flex justify-center py-8 xl:py-12 bg-white">
        <div className="max-w-[75rem] w-full px-8">
          <div className="text-center mb-8">
            <h2 className={`${Termina} font-black text-[2rem] md:text-[2.5rem] xl:text-[3rem] leading-tight`}>
              <span className="text-[#FFC107]">BROWSE</span>{' '}
              <span className="text-black">CUSTOM POLO SHIRT</span>
              <br />
              <span className="text-[#FFC107]">PRODUCTS BY INDUSTRY</span>
            </h2>
            <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 max-w-4xl mx-auto`}>
          ...
          <div className="relative overflow-hidden rounded-lg mb-6 shadow-lg">
            <div className="relative h-[400px] md:h-[500px]">
              <Image
                ...
                fill
                alt="Business - Custom shirts for restaurants, gyms, cafes"
                className="object-cover"
                loading="lazy"
                sizes="100vw"
                quality={85}
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 text-white">
                <h3 className={`${Termina} font-black text-4xl md:text-5xl xl:text-6xl mb-4 uppercase`}>
                  BUSINESS
                </h3>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="relative overflow-hidden rounded-lg group cursor-pointer h-[350px] shadow-lg">
              ...
              <div className="absolute bottom-0 left-0 right-0 flex justify-center pb-6">
                <div className={`${Termina} bg-[#FFC107] text-black font-black py-3 px-8 rounded-full text-sm md:text-base uppercase shadow-lg`}>
                  NON PROFIT
                </div>
              </div>
            </div>
        ...
        <div className="max-w-[75rem] w-full flex flex-col xl:flex-row items-center gap-6 xl:gap-10 px-8 relative">
          ...
          <div className="w-full xl:w-[60%] flex flex-col items-center xl:items-start text-center xl:text-left">
            ...
            <p className={`${MaisonNeue} text-white text-base md:text-lg mb-8 max-w-[650px] leading-relaxed`}>
              Our expert design team is ready to bring your polo shirt vision to life. Get a free digital mockup or work with our professional designers to create the perfect look for your team.
            </p>
          ...
          <div className="w-full xl:w-[53%] xl:absolute xl:right-0 xl:translate-x-[15%]">
            <div className="relative w-full h-[400px] xl:h-[600px]">
              <Image
                src="/custom-polo-shirts/14-converted-from-png.webp"
                fill
      ...
      <section className="w-full bg-white py-8 xl:py-12">
        <div className="max-w-[75rem] mx-auto px-8">
          ...
          <div className="text-center mb-10">
            ...
            <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 max-w-4xl mx-auto`}>
              Have questions about custom polo shirts? Browse our FAQ to learn about our products, decoration methods, ordering process, and more.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto space-y-4">
            ...
            <div className={`${openFaqIndex === 0 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  What&apos;s the difference between embroidery and screen printing for polo shirts?
                </h3>
              ...
              {openFaqIndex === 0 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    Embroidery gives a textured look suited to logos and holds up well with frequent use. Screen printing suits bold, larger art and keeps colours clear. We can guide you on the right choice; see our <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/services/screen-printing'>screen printing</a></span> page for details.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className={`${openFaqIndex === 1 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  What is the minimum order quantity for custom polo shirts?
                </h3>
                <span className="text-2xl font-bold text-black flex-shrink-0">
                  {openFaqIndex === 1 ? '×' : '+'}
                </span>
              ...
              {openFaqIndex === 1 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    Our minimum order for custom polo shirts is 12 pieces when using screen printing. Embroidery can be done in smaller runs, giving added flexibility. Reach us through our <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/contact'>contact page</a></span> if you have sizing or quantity requests for your project.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className={`${openFaqIndex === 2 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  How long does production take for custom polo shirts?
                </h3>
                <span className="text-2xl font-bold text-black flex-shrink-0">
                  {openFaqIndex === 2 ? '×' : '+'}
                </span>
              ...
              {openFaqIndex === 2 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    Production for custom polo shirts usually takes 1-2 weeks once artwork is approved. Timing may vary based on the method and quantity. If you need items sooner, rush options can be arranged for an added fee, depending on current capacity.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className={`${openFaqIndex === 3 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  Can I mix and match polo shirt sizes in one order?
                </h3>
                <span className="text-2xl font-bold text-black flex-shrink-0">
                  {openFaqIndex === 3 ? '×' : '+'}
                </span>
              ...
              {openFaqIndex === 3 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    Yes! You can mix sizes in a single <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/products/category/polos/polo'>polo shirt order</a></span> without extra charges. Most styles come in Small through 3XL, giving you plenty of range for groups or teams. Pick the quantities you need for each size, and we’ll handle the full run together.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className={`${openFaqIndex === 4 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  What polo shirt brands do you offer?
                </h3>
                <span className="text-2xl font-bold text-black flex-shrink-0">
                  {openFaqIndex === 4 ? '×' : '+'}
                </span>
              ...
              {openFaqIndex === 4 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    We offer polo shirts from Nike, Port Authority, Gildan, Sport-Tek and others, each with its own fabric feel, fit and price range. This helps match your project to the right option. View our full <span className="text-[#FFC107]"><a href='https://www.teevisionprinting.com/products'>product range</a></span> to see the styles available.
                  </p>
                </div>
              )}
            </div>
...
export default CustomPoloShirts;