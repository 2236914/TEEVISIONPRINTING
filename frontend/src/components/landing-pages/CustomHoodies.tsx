...
const PROJECTS: Project[] = [
  { imageSrc: '/custom-hooodies/2-converted-from-png.webp' },
  { imageSrc: '/custom-hooodies/3-converted-from-png.webp' },
  { imageSrc: '/custom-hooodies/4-converted-from-png.webp' },
  { imageSrc: '/custom-hooodies/5-converted-from-png.webp' },
];
...
const PRODUCT_DATA: Record<string, Product[]> = {
  'HOODED SWEATSHIRTS': [
    ...
    {
      name: 'Independent Trading Co. Full-Zip Hoodie (IND4000Z)',
      rating: 5.0,
      price: '$48.75 / hoodie',
      image: '/custom-hooodies/independent-trading-co-heavyweight-full-zip-hooded-sweatshirt-ind4000z-converted-from-png.webp',
      link: '/products/view/independent-trading-co-heavyweight-full-zip-hooded-sweatshirt-ind4000z'
    },
    {
      name: 'Gildan Adult Heavy Blend™ Full-Zip Hooded Sweatshirt (G186)',
      rating: 5.0,
      price: '$46.03 / hoodie',
      image: '/custom-hooodies/gildan-adult-heavy-blend-full-zip-hooded-sweatshirt-converted-from-png.webp',
      link: '/products/view/gildan-adult-heavy-blend-full-zip-hooded-sweatshirt'
    },
    {
      name: 'Independent Trading Co. Midweight Hooded Sweatshirt (SS4500)',
      rating: 5.0,
      price: '$42.50 / hoodie',
      image: '/custom-hooodies/independent-trading-co-midweight-hooded-sweatshirt-ss4500-converted-from-png.webp',
      link: '/products/view/independent-trading-co-midweight-hooded-sweatshirt-ss4500'
    }
  ],
  'ZIP UPS': [
    {
...
const ProductTabsHeader = memo(({ activeTab, setActiveTab }: { activeTab: string; setActiveTab: (tab: string) => void }) => {
  const tabs = ['HOODED SWEATSHIRTS', 'ZIP UPS', 'CREWNECK SWEATSHIRTS'];
          ...
          >
            {projects.map((project, index) => (
              <div
                ...
                role="button"
                tabIndex={0}
                aria-label={`View featured hoodie design ${index + 1}`}
              >
                <div className="relative aspect-square w-full">
                  <Image
                    src={project.imageSrc}
                    fill
                    alt={`Featured hoodie design ${index + 1}`}
...
// Main Component
const CustomHoodies = () => {
  const [activeTab, setActiveTab] = useState('HOODED SWEATSHIRTS');
  ...
  return (
    <main className="bg-white">
      ...
      <section className="w-full relative flex overflow-hidden bg-[#1a1a1a]">
        <div className="flex flex-col w-full z-[1]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-8 md:px-12 xl:px-24 py-16 md:py-20 xl:py-24 pt-32 md:pt-36 xl:pt-40">
            ...
            <div className="flex flex-col gap-8 text-white">
              <div>
                <p className={`${MaisonNeue} text-base md:text-lg xl:text-3xl font-normal uppercase tracking-wide text-white`}>
                  MAKE YOUR VISION STAND OUT WITH 
                </p>
                <h1 className={`${Termina} uppercase font-black text-6xl md:text-7xl xl:text-8xl 2xl:text-7xl mt-2 leading-[0.9]`}>
                  ...
                  <br />
                  <span className="text-[#FFC107]">HOODIES</span>
                </h1>
              </div>
              <p className={`${MaisonNeue} text-base md:text-lg xl:text-xl text-gray-300 max-w-2xl leading-relaxed`}>
                Custom screen printing service to showcase your ideas onto durable quality, T-shirt, hoodie, or tote bag, and more.
              </p>
            ...
            {/* Right Side - Hero Image (hoodies on rack) */}
            <div className="flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[700px] aspect-[4/3] rounded-3xl overflow-hidden">
                <Image
                  src="/custom-hooodies/1-converted-from-png.webp"
                  fill
                  alt="Colorful custom hoodies on rack"
      ...
      {/* Featured Hoodie Designs Section */}
        ...
        <div className="max-w-[75rem] mx-auto px-8">
          ...
          <div className="text-center mb-12">
            <h2 className={`${Termina} font-black text-[2.5rem] md:text-[3rem] xl:text-[3.5rem] mb-4`}>
              ...
              <span className="text-[#FFC107]">CUSTOM HOODIES</span>
            </h2>
          </div>
          ...
          <div className="max-w-[75rem] w-full px-8">
            <div className="text-center mb-8">
              <h2 className={`${Termina} font-black text-[#FFC107] text-[2rem] md:text-[2.5rem] xl:text-[3rem] mb-4`}>
                <span className="text-[#000000]">SEE OUR </span>HOODIE COLLECTIONS
              </h2>
      ...
      <section className="w-full bg-white py-16">
        <div className="max-w-[75rem] mx-auto px-8">
          ...
          <div className="text-center mb-12">
            <h2 className={`${Termina} font-black text-[2.5rem] md:text-[3rem] xl:text-[3.5rem] mb-4`}>
              <span className="text-[#FFC107]">CUSTOM HOODIES PRINTING METHODS</span>
            </h2>
            <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 max-w-4xl mx-auto`}>
              At Tee Vision Printing, we create custom hoodies using reliable printing methods for bold, long-lasting designs. Click to see which method fits your hoodie project.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link href="/services/screen-printing" className="group">
              <div className="relative overflow-hidden rounded-lg border-4 border-transparent hover:border-[#FFC107] transition-all duration-300 h-full flex flex-col">
                <div className="relative h-64 flex-grow">
                  <Image
                    src="/custom-hooodies/6-converted-from-png.webp"
                    fill
            ...
            <Link href="/services/embroidery" className="group">
              <div className="relative overflow-hidden rounded-lg border-4 border-transparent hover:border-[#FFC107] transition-all duration-300 h-full flex flex-col">
                <div className="relative h-64 flex-grow">
                  <Image
                    src="/custom-hooodies/7-converted-from-png.webp"
                    fill
            ...
            <Link href="/services/dtg" className="group">
              <div className="relative overflow-hidden rounded-lg border-4 border-transparent hover:border-[#FFC107] transition-all duration-300 h-full flex flex-col">
                <div className="relative h-64 flex-grow">
                  <Image
                    src="/custom-hooodies/8-converted-from-png.webp"
                    fill
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full aspect-square mb-4 overflow-hidden">
          <Image
            src="/custom-hooodies/New/1-converted-from-png.webp"
            fill
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full aspect-square mb-4 overflow-hidden">
          <Image
            src="/custom-hooodies/New/2-converted-from-png.webp"
            fill
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full aspect-square mb-4 overflow-hidden">
          <Image
            src="/custom-hooodies/11-converted-from-png.webp"
            fill
      ...
      {/* Our Custom Hoodies Are Great Section */}
        ...
        <div className="max-w-[75rem] mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-12 items-center">
            ...
            <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden rounded-lg">
              <Image
                src="/custom-hooodies/12-converted-from-png.webp"
                fill
                alt="Custom hoodies collection"
                className="object-cover"
                loading="lazy"
            ...
            <div className="flex flex-col gap-6">
              <h2 className={`${Termina} font-black text-[2rem] md:text-[2.5rem] xl:text-[3.5rem] leading-tight`}>
                <span className="text-black">Our Custom Hoodies</span>
                <br />
                <span className="text-black">Are Great!</span>
              </h2>
              <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                Bring your ideas to life with Custom Hoodies from Tee Vision Printing in Philadelphia! Perfect for businesses, events, or personal style, our high-quality prints deliver standout designs, great value, and Philly flair every time.
              </p>
        ...
        <div className="max-w-[75rem] w-full px-8">
          <div className="text-center mb-8">
            <h2 className={`${Termina} font-black text-[2rem] md:text-[2.5rem] xl:text-[3rem] leading-tight`}>
              ...
              <span className="text-black">CUSTOM HOODIES</span>
              <br />
              <span className="text-[#FFC107]">PRODUCTS BY INDUSTRY</span>
            </h2>
            <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 max-w-4xl mx-auto`}>
              Outfit your team in style with custom business apparel that makes a lasting impression. From staff shirts and café uniforms to gym tees and promotional giveaways, our premium screen printing help your brand look professional, polished, and unified. Perfect for restaurants, offices, retail shops, and corporate events.
              </p>
          </div>
        ...
        <div className="max-w-[75rem] w-full flex flex-col xl:flex-row items-center gap-6 xl:gap-10 px-8 relative">
          ...
          <div className="w-full xl:w-[60%] flex flex-col items-center xl:items-start text-center xl:text-left">
            ...
            <p className={`${MaisonNeue} text-white text-base md:text-lg mb-8 max-w-[650px] leading-relaxed`}>
              Ready to bring your design to life? Tee Vision Printing offers free digital mockups and expert design support so you can visualize your custom hoodies before printing. Whether you’re creating apparel for your business, event, or brand, our team guides you from concept to completion with smooth, high-quality results. Check out our{' '}
          ...
          <div className="w-full xl:w-[53%] xl:absolute xl:right-0 xl:translate-x-[15%]">
            <div className="relative w-full h-[400px] xl:h-[600px]">
              <Image
                src="/custom-hooodies/New/5-converted-from-png.webp"
                fill
      ...
      <section className="w-full bg-white py-8 xl:py-12">
        <div className="max-w-[75rem] mx-auto px-8">
          ...
          <div className="text-center mb-10">
            ...
            <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 max-w-4xl mx-auto`}>
              Got questions about custom hoodies? Explore our Frequently Asked Questions to learn more about our products, printing process, and ordering.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto space-y-4">
            ...
            <div className={`${openFaqIndex === 0 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  What materials are used for high-quality custom hoodies?
                </h3>
              ...
              {openFaqIndex === 0 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    Most custom-printed hoodies use cotton, polyester, or a cotton-poly blend because these fabrics hold prints well and provide a smooth, durable surface for screen printing, DTG, embroidery, or heat transfer.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className={`${openFaqIndex === 1 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  How long does it take to receive custom hoodies after ordering online?
                </h3>
                <span className="text-2xl font-bold text-black flex-shrink-0">
                  {openFaqIndex === 1 ? '×' : '+'}
                </span>
              ...
              {openFaqIndex === 1 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    Turnaround for custom-printed hoodies usually takes 7-14 business days, depending on the printing method, order size, and artwork approval.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className={`${openFaqIndex === 2 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  Can I bulk order custom hoodies with my company logo?
                </h3>
                <span className="text-2xl font-bold text-black flex-shrink-0">
                  {openFaqIndex === 2 ? '×' : '+'}
                </span>
              ...
              {openFaqIndex === 2 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    Yes. Bulk orders with company logos are available and often come with discounted pricing. Bulk screen printing or embroidery is ideal for corporate branding, team wear, or events.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className={`${openFaqIndex === 3 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  What are the popular printing techniques for custom hoodies?
                </h3>
                <span className="text-2xl font-bold text-black flex-shrink-0">
                  {openFaqIndex === 3 ? '×' : '+'}
                </span>
              ...
              {openFaqIndex === 3 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                   The most common printing methods are screen printing, DTG (direct-to-garment), embroidery, and heat transfer vinyl (HTV). Each offers different benefits depending on the design, number of colors, and order quantity.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className={`${openFaqIndex === 4 ? 'bg-gray-100' : 'bg-[#E8EAF6]'} rounded-3xl overflow-hidden transition-colors`}>
              ...
              >
                <h3 className={`${MaisonNeue} font-bold text-lg md:text-xl text-black pr-4`}>
                  What sizes are available for custom hoodies?
                </h3>
                <span className="text-2xl font-bold text-black flex-shrink-0">
                  {openFaqIndex === 4 ? '×' : '+'}
                </span>
              ...
              {openFaqIndex === 4 && (
                <div className="px-6 md:px-8 pb-6">
                  <p className={`${MaisonNeue} text-base md:text-lg text-gray-700 leading-relaxed`}>
                    We’ve got you covered from S to 3XL (and some up to 5XL), plus youth sizes. Our sizing guides help you pick the perfect fit for everyone in your group or team.
                  </p>
                </div>
              )}
            </div>
