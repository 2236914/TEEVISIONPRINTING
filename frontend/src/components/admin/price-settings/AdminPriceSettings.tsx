...
const AdminPriceSettings = () => {
  ...
  if (priceSettingsQuery.isLoading) {
    return (
      <div className="flex items-center justify-center gap-8 w-screen h-screen bg-background5 ml-64 p-12">
  ...
  return (
    <div className="flex flex-col gap-8 w-full h-full ml-64 p-16">
      <div className="flex bg-background5 w-full">
        <div className="flex flex-col gap-12 bg-background5 flex-grow">
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-8 bg-background4 p-8 rounded-lg">
              <h2 className="text-2xl font-bold">Front Print Location</h2>
          ...
          <div className="flex flex-col gap-8 bg-background4 p-8 rounded-lg">
            <h2 className="text-2xl font-bold">Back Print Location</h2>
            <PriceTableWithLegends
          ...
          <div className="flex flex-col gap-8 bg-background4 p-8 rounded-lg">
            <h2 className="text-2xl font-bold">Quantity Restrictions</h2>
          ...
          <div className="flex flex-col gap-8 bg-background4 p-8 rounded-lg">
            <h2 className="text-2xl font-bold">Items per Package</h2>
            <div className="flex gap-8">
              <div className="flex items-center gap-4">
                <label
          ...
          <div className="flex flex-col gap-8 bg-background4 p-8 rounded-lg">
            <h2 className="text-2xl font-bold">Admin Fees</h2>
            <div className="flex items-center gap-4">
              <input
                type="number"
                className="input input-md input-bordered w-[14rem]"
