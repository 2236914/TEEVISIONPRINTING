...
const ProductTabsMobile: React.FC<PropTypes> = ({
  handleTabChange,
  tabSelected,
}) => {
  return (
    <div className="flex w-full md:pt-8">
      <div
        className={`product-tabs-mobile relative w-full ${
          tabSelected === 0 ? 'z-50' : 'z-10'
        } `}
      >
        <div
          className={`product-tabs-mobile__trapezoid-parent absolute w-full h-full`}
        >
          <svg
            width="200"
            height="120"
            ...
            className="absolute h-full top-[0.2rem] product-tabs-mobile__first-trapezoid"
          >
            <path
          ...
          >
            ...
            >
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="product-tabs-mobile__icon"
              >
                <path
      ...
      >
        ...
        >
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute h-full top-[0.2rem] -left-4 product-tabs-mobile__second-trapezoid"
          >
            <path
          ...
          <button
            type="button"
            className="w-full h-full absolute z-10 flex items-center justify-center -left-3"
      ...
      <div
        className={`product-tabs-mobile relative w-full z-0 ${
      ...
      >
        ...
        >
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute h-full -left-9 top-[0.2rem] product-tabs-mobile__second-trapezoid"
          >
            <path
              d="M119.405 2.98754L163.352 57.6538H0L32.7075 3.84468C34.1586 1.45738 36.75 0 39.5437 0H113.17C115.594 0 117.887 1.09867 119.405 2.98754Z"
              fill="white"
          ...
          <button
            type="button"
            className="w-full h-full absolute z-10 flex items-center justify-center -left-6"
